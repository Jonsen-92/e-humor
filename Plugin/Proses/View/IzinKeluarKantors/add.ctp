...
<script>
    ...
    var IzinKeluarKantor = function(){
        var handleValidation = function() {
            $('#IzinKeluarKantorAddForm').validate({
                rules: {
...
<h3><b>Form Izin Keluar Kantor</b></h3>
<br>
...
<div class="col-md-6">
    <?php 
        ...
        echo $this->Form->input('tanggal_izin', array('label' => array('text' => 'Tanggal Izin', 'class' => 'col-md-3 control-label'),'type' => 'text', 'class' => 'form-control','readonly', 'between' => '<div class="col-sm-8">', 'after' => '</div>'));

        echo $this->Form->input('jam_mulai', array('label' => array('text' => 'Dari Jam', 'class' => 'col-md-3 control-label'),'type' => 'select', 'options'=>$jam,'onchange'=>'validasiJam()' ,'class' => 'form-control','readonly', 'between' => '<div class="col-sm-8">', 'after' => '</div>'));

        echo $this->Form->input('jam_akhir', array('label' => array('text' => 'Sampai Jam', 'class' => 'col-md-3 control-label'),'type' => 'select', 'options'=>$jam,'onchange'=>'validasiJam()' ,'class' => 'form-control','readonly', 'between' => '<div class="col-sm-8">', 'after' => '</div>'));
