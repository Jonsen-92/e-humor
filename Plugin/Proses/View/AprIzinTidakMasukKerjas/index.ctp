	...
	<tr<?php echo $i%2==0?' class="altrow"':'';?>>
		...
		<?php
            ...
            if($v[$model]['apr_pemberi_izin'] == 'PROSES'){
                echo $this->Html->link(__('', true), array('action' => 'approve', $v[$model]['id']), array('class' => 'btn fa fa-check','title'=>'Persetujuan Izin Tidak Masuk Kerja'), __('Apakah anda yakin menyetujui izin tidak masuk kerja # %s?', $v[$model]['nama_pemohon']));
                    ...
                    <div class="modal fade in" id="modal<?php echo $v[$model]['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <?php echo $this->Form->create('IzinTidakMasukKerja', array('type'=>'file','url'=>'disapprove/'.$v[$model]['id']));?>
