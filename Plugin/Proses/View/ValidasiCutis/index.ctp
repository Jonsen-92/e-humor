...
<div class="index" style="overflow-x:auto;">
	...
	<tr<?php echo $i%2==0?' class="altrow"':'';?>>
		...
		<td>
		<?php  if($v[$model]['status_apr_ppk'] == 'PROSES'){
                        echo "<span class='badge btn-warning'>PROSES</span>";
                    }
		...
		<?php
            ...
            if($v[$model]['status_validasi'] == 'PROSES'){
                echo $this->Html->link(__('', true), array('action' => 'valid', $v[$model]['id']), array('class' => 'btn fa fa-check','title'=>'Validasi Pengajuan Cuti'), __('Apakah anda yakin validasi cuti # %s?', $v[$model]['nama']));
                    ...
                    <div class="modal fade in" id="modal<?php echo $v[$model]['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <?php echo $this->Form->create('PengajuanCuti', array('type'=>'file','url'=>'notvalid/'.$v[$model]['id']));?>
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <?php
                                                echo $this->Form->input('alasan_validasi',array('label'=>false,'type'=>'textarea','class'=>'form-control','between'=>'<div class="col-sm-12">','after'=>'</div>'));
                                            ?>
                                        </div>
                                    </div>
