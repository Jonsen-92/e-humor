...
class AprCutiPembinasController extends AppController {

	public $name = 'AprCutiPembinas';
	var $model='PengajuanCuti';
	// public $uses=array('SysConfig.AprCutiPembina');
    ...
    function index()
	{
        ...
        $conditions[]=' nip_ppk = "'.$nip.'"';
        $conditions[]=' status_apr_atasan = "DISETUJUI"';
    ...
    function approve($id,$nip)
    {
        ...
        $dataPengajuan = $this->PengajuanCuti->find('first', array('conditions'=>array('id'=>$id)));
        ...
        $jumlahPengajuan = $dataPengajuan['PengajuanCuti']['jumlah_cuti'];
