...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard Cuti Online</title>
<!--
...
-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">Aplikasi E-HUMOR</a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="#welcome" class="active">Home</a></li>
                            <li class="scroll-to-section"><a href="#list_cuti">Data Pegawai Tidak Bekerja </a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        ...
                        <h1><strong>PENGADILAN NEGERI PEMATANGSIANTAR</strong></h1>
                        <p>Silahkan Klik <b>Sign In</b> jika anda berstatus Pegawai dan Klik <b>Data Pegawai Sedang Cuti</b> untuk melihat data Pegawai yang sedang cuti</p>
                        <a href="/edaran/login" class="main-button-slider">Sign In</a>
                        <a href="#list_cuti" class="main-button-slider">Data Pegawai Tidak Bekerja</a>
                    </div>
    ...
    <!-- <section class="section" id="list_cuti">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2>Data Pegawai Tidak Bekerja</h2>
                    </div>
                </div>
                        ...
                        <article class="accordion">
                            ...
                            <div class="accordion-body">
                                ...
                                <table id="customers">
                                    ...
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        <td><?php echo $v['pengajuan_cutis']['nip']; ?></td>
                                        <td><?php echo $v['pengajuan_cutis']['nama']; ?></td>
                                        <td><?php echo $v['pengajuan_cutis']['jabatan']; ?></td>
                                        <td><?php echo date('d M y', strtotime($v['pengajuan_cutis']['dari_tanggal'])). ' s/d '.date('d M y', strtotime($v['pengajuan_cutis']['sampai_tanggal'])); ?></td>
                                        <td><?php echo $v['pengajuan_cutis']['desc_jenis_cuti']; ?></td>
                                    </tr>
                                    <?php $no++; } ?>
                                </table>
                                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    -->
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15938.044332956266!2d99.0611912!3d2.9555851!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3031845a5b046a79%3A0x6d1cd55ecdc88a95!2sPengadilan%20Negeri%20Pematang%20Siantar!5e0!3m2!1sid!2sid!4v1689213001850!5m2!1sid!2sid" width="100%" height="500px" frameborder="0" style="border:0;" allowfullscreen></iframe>
                    </div>
                </div>
                <!-- ***** Contact Map End ***** -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <p class="copyright">Copyright &copy; <?php echo date('Y'); ?> PN PMS Developer Team 
                
                . Visit Our Website: <a rel="nofollow" href="https://www.pn-pematangsiantarkota.go.id/" target="_blank">PN Pematangsiantar</a></p>
                </div>
