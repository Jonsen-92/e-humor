...
<div class="<?php echo Inflector::variable($this->name);?>form">
	...
	<nav aria-label="Page navigation">
            <?php echo ($simplepaging['first'][$model][$simplepaging['primaryKey']]<>$id) ? $this->Html->link('<< First', array($simplepaging['first'][$model][$simplepaging['primaryKey']]), array('class'=>'btn btn-primary btn-xs')):'<button type="button" class="btn btn-primary btn-xs" disabled><< First</button>';?>
            <?php echo (isset($simplepaging['prev'][$model][$simplepaging['primaryKey']]) and !empty($simplepaging['prev'][$model][$simplepaging['primaryKey']])) ? $this->Html->link('< Prev', array($simplepaging['prev'][$model][$simplepaging['primaryKey']]), array('class'=>'btn btn-primary btn-xs')):'<button type="button" class="btn btn-primary btn-xs" disabled>< Prev</button>';?>
            <?php echo (isset($simplepaging['next'][$model][$simplepaging['primaryKey']]) and !empty($simplepaging['next'][$model][$simplepaging['primaryKey']]))?$this->Html->link('Next >', array($simplepaging['next'][$model][$simplepaging['primaryKey']]), array('class'=>'btn btn-primary btn-xs')):'<button type="button" class="btn btn-primary btn-xs" disabled>Next ></button>';?>
            <?php echo ($simplepaging['last'][$model][$simplepaging['primaryKey']]<>$id)?$this->Html->link('Last >>', array($simplepaging['last'][$model][$simplepaging['primaryKey']]), array('class'=>'btn btn-primary btn-xs')):'<button type="button" class="btn btn-primary btn-xs" disabled>last >></button>';?>
	</nav>
	...
	<?php  echo $this->Master->getFormMaster($data['field'], $model, true);?>
	</form>
</div>
